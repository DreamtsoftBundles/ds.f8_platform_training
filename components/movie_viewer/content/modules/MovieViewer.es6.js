...
const WrapperTitle = require('react-core/components/WrapperTitle');
const WrapperBody = require('react-core/components/WrapperBody');

class MovieViewer extends F8ReactComponent {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
            ...
            render: function() {
                ...
                return (
					<div>
						...
						<Hero />
						<TitleList title="Top TV picks for Jerrod" url='discover/tv?sort_by=popularity.desc&page=1' />
            ...
            render: function() {
                return (
					<div className="UserProfile">
						<div className="User">
							<div className="name">Jerrod Bennett</div>
							<div className="image"><img src="https://psyc2301.wikispaces.com/file/view/south_park_cartman-1045.jpg/134221761/south_park_cartman-1045.jpg" /></div>
						</div>
        ...
        ReactDOM.render(
			<App />,
            document.getElementById('movieViewer')
        );
	}
